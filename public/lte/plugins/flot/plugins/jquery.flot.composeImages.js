...
function, which generates temporary img out of them. This function
...
failure in generating the temporary image. Temporary img are required
...
After all temporary img are generated, they are overlapped using
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                successCallbackFunc(tempImg); //call successCallback, to allow snapshot of all working img
            };
    ...
    function prepareImagesToBeComposed(sources, destination) {
        ...
        if (sources.length === 0) {
            ...
            if ((maxX - minX <= 0) || (maxY - minY <= 0)) {
                result = NEGATIVEIMAGESIZE; //this might occur on hidden img
            } else {
